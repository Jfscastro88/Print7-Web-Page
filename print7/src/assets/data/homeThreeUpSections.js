export default function getHomeThreeUpSections(t) {
  ...
  return [
    ...
    {
      title: t("home.threeUp.gifts.title"),
      subtitle: t("home.threeUp.gifts.subtitle"),
      to: "/gifts",
    ...
    {
      title: t("home.threeUp.stationery.title"),
      subtitle: t("home.threeUp.stationery.subtitle"),
      to: "/stationery",
