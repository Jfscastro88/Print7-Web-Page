...
const IMAGES = [
  ...
  { src: imgVitrin11, alt: 'AD #11'}, { src: imgVitrin12, alt: 'AD #12'},
  { src: imgVitrin13, alt: 'AD #13'}, { src: imgVitrin14, alt: 'AD #14'},
  { src: imgVitrin15, alt: 'AD #15'}, { src: imgVitrin16, alt: 'AD #16'},
  { src: imgVitrin17, alt: 'AD #17'}, { src: imgVitrin18, alt: 'AD #18'},
  { src: imgVitrin19, alt: 'AD #19'}, { src: imgVitrin20, alt: 'AD #20'},
  { src: imgVitrin21, alt: 'AD #21'}, { src: imgVitrin22, alt: 'AD #22'},
  { src: imgVitrin23, alt: 'AD #23'}, { src: imgVitrin24, alt: 'AD #24'},
  { src: imgVitrin25, alt: 'AD #25'}, { src: imgVitrin26, alt: 'AD #26'},
  { src: imgVitrin27, alt: 'AD #27'}, { src: imgVitrin28, alt: 'AD #28'},
  { src: imgVitrin29, alt: 'AD #29'}, { src: imgVitrin30, alt: 'AD #30'},
  { src: imgVitrin31, alt: 'AD #31'}, { src: imgVitrin32, alt: 'AD #32'},
