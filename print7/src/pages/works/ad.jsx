...
const IMAGES = [
{ src: imgAdvertising1, alt: 'AD #1'}, { src: imgAdvertising2, alt: 'AD #2'},
{ src: imgAdvertising3, alt: 'AD #3'}, { src: imgAdvertising4, alt: 'AD #4'},
{ src: imgAdvertising5, alt: 'AD #5'}, { src: imgAdvertising6, alt: 'AD #6'},
{ src: imgAdvertising7, alt: 'AD #7'}, { src: imgAdvertising8, alt: 'AD #8'},
{ src: imgAdvertising9, alt: 'AD #9'}, { src: imgAdvertising10, alt: 'AD #10'},
{ src: imgAdvertising11, alt: 'AD #11'}, { src: imgAdvertising12, alt: 'AD #12'},
{ src: imgAdvertising13, alt: 'AD #13'}, { src: imgAdvertising14, alt: 'AD #14'},
{ src: imgAdvertising15, alt: 'AD #15'}, { src: imgAdvertising16, alt: 'AD #16'},
{ src: imgAdvertising17, alt: 'AD #17'}, { src: imgAdvertising18, alt: 'AD #18'},
