    ...
    <main className="bg-white">
      ...
      <section className="max-w-3xl mx-auto px-6 py-14 text-gray-800 leading-relaxed">
        ...
        <div className="mt-8 space-y-6">
          ...
          <ul className="list-disc pl-6 space-y-2">
            <li>
              <strong>{t("legalBases.legit.title")}</strong> {t("legalBases.legit.text")}
            </li>
            <li>
              <strong>{t("legalBases.contract.title")}</strong> {t("legalBases.contract.text")}
            </li>
            <li>
              <strong>{t("legalBases.legal.title")}</strong> {t("legalBases.legal.text")}
            </li>
          </ul>
          ...
          <ul className="list-disc pl-6 space-y-2">
            <li>
              <strong>{t("retention.logs.title")}</strong> {t("retention.logs.text")}
            </li>
            <li>
              <strong>{t("retention.contacts.title")}</strong> {t("retention.contacts.text")}
            </li>
          </ul>
